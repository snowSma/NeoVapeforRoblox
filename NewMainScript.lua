...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		return game:HttpGet("https://raw.githubusercontent.com/snowSma/NeoVapeforRoblox/main/"..scripturl, true)
	end
end
...
if getasset == nil then
	print("getasset not found, using fallback")
...
local queueteleport = syn and syn.queue_on_teleport or queue_on_teleport or fluxus and fluxus.queue_on_teleport or function() 
	print("queueteleport not available, using dummy function")
end
...
local function checkpublicrepo(id)
	local req = requestfunc({
		Url = "https://raw.githubusercontent.com/snowSma/NeoVapeforRoblox/main/CustomModules/"..id..".vape",
		Method = "GET"
	})
...
local function getcustomassetfunc(path)
	if not isfile(path) then
		local req = requestfunc({
			Url = "https://raw.githubusercontent.com/snowSma/NeoVapeforRoblox/main/"..path:gsub("vape/assets", "assets"),
			Method = "GET"
		})
...
print("Creating general settings...")
...
local teleportfunc = game:GetService("Players").LocalPlayer.OnTeleport:Connect(function(State)
    if State == Enum.TeleportState.Started then
        ...
        queueteleport('shared.VapeSwitchServers = true if shared.VapeDeveloper then loadstring(readfile("vape/NewMainScript.lua"))() else loadstring(game:HttpGet("https://raw.githubusercontent.com/snowSma/NeoVapeforRoblox/main/NewMainScript.lua", true))() end')
    end
end)
...
if pcall(function() readfile("vape/CustomModules/"..game.PlaceId..".vape") end) then
	print("Loading custom module for PlaceId:", game.PlaceId)
	loadstring(readfile("vape/CustomModules/"..game.PlaceId..".vape"))()
else
	print("Checking public repo for PlaceId:", game.PlaceId)
	local publicrepo = checkpublicrepo(game.PlaceId)
	if publicrepo then
		print("Found public module, loading...")
		loadstring(publicrepo)()
	else
		print("No custom module found for this game")
	end
end
...
print("========== VAPE LOADED SUCCESSFULLY ==========")
